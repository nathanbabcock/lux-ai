import { SerializedState, Unit } from '@lux-ai/2021-challenge';
...
export const parseKaggleObs = (obs: KaggleObservation): SerializedState => {
  ...
  // console.log('parse after creation = ', parse, 'is a parser?', parse instanceof Parser)
  ...
  for (const _update of obs.updates) {
    // console.log('parse obj = ', parse)
    // console.log('parse.parse = ', parse.parse)
